...
class ChainRequest extends ChainBuilder {
  ...
  /**
   * @method use
   * @description A router function, purpose to make open APIs of ChainRequest more unified.
   * @param arg {Object} - Config object.
   * @param arg.type {'middleware'|'setup'} - Function router type, use this to separate different uses.
   *                                          - 'setup' happens before chain steps.
   *                                          - 'middleware' is nodes in chain, middlewares you push will be process in the progress.
